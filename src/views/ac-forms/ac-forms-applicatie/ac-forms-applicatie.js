...
const AcFormsApplicatieInner = ({ store, formType, applicatieId, redirect }) => {
  ...
  const [applicatie, setApplicatie] = useState({
    ...
    website: 'test.test.nl',
    contactpersoon: '32e18d87-a19c-4b8c-ad6c-4c56ee0d9515',
    cloudDienstverleningsmodel: ['IaaS', 'SaaS', 'On-premises (self-managed)'],
    hostingJurisdictie: 'US',
    hostingLocatie: 'EU',
    aanbieder: '376d46ac-76eb-4cd7-868a-c92a274e9034',
    licentietype: 'Open source',
    licentie: 'GNU General Public License (GPL)',
    referentieComponenten: ['e08c27b8-abc6-4c23-b564-dcf69d4cea54'],
    type: 'Applicatie',
