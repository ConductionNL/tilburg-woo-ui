...
const ConKoppelingStepSoort = ({
  ...
  return (
    ...
    >
      ...
      <Paragraph>
        <strong>Voor eigen organisatie:</strong> Het opgeven van gebruik van een koppeling op in gebruik zijnde software binnen de eigen organisatie.
        <br />
        <strong>Aanbieden koppeling:</strong> Het aanbod van een koppeling op bestaand product. Indien het een koppeling betreft op product van andere partij(en) kan tevens meteen een dienst worden toegevoegd.
      </Paragraph>
        ...
        <AcGrid columns={2} gap='xl'>
          <AcTile
            ...
            className={`ac-dashboard-wizard-tile ${
              koppelingsType === 'eigen-organisatie' ? 'ac-tile--selected' : 'ac-tile--not-selected'
            }`}
          ...
          <AcTile
            ...
            size='medium'
            className={`ac-dashboard-wizard-tile ${
              koppelingsType === 'aanbieden-koppeling' ? 'ac-tile--selected' : 'ac-tile--not-selected'
            }`}
