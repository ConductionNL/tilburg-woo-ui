...
const AcFormsKoppeling = () => {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      // Changed endpoint to /koppeling
      const response = await fetch(
        `${BASE_URL}/openconnector/api/endpoint/koppeling`,
        {
          method: 'POST',
          headers: {
  ...
  if (registerCallBack === 'success') {
    return (
      <AcSection spacing>
        <AcContainer>
          <AcColumn gap="lg">
            <Heading1>Koppeling Aanmelding Gelukt!</Heading1>
            <Alert type="ok">
              <Paragraph>
                Uw koppeling aanmelding is succesvol ingediend. U ontvangt
      ...
      <AcContainer>
        <AcColumn gap="lg">
          <div>
            ...
            <Paragraph>
              Vul dit formulier in om een koppeling aan te melden voor integratie
              met onze systemen.
            </Paragraph>
          </div>
          ...
          <ProcessSteps
            steps={[
              { status: currentStep >= 0 ? 'current' : 'incomplete', title: 'Koppelinggegevens' },
          ...
          <div className="ac-register-form-content">
            ...
            <p>Koppeling formulier content for step {currentStep + 1} would go here...</p>
          </div>
          ...
          <div className="ac-register-form-actions">
            ...
            {currentStep < 2 ? (
              ...
              <AcButton
                ...
                disabled={!isFormValid || loading}
              >
                {loading ? 'Bezig met verzenden...' : 'Koppeling Aanmelden'}
              </AcButton>
            )}
          </div>
        </AcColumn>
