...
/**
 * Deelnemers Stage Component for Dienst Form
 *
 * This stage is shown for the Gebruik-beheerders flow (ontbrekend-dienst type).
 ...
 */
const ConFormDeelnemersStage = memo(
  ({
    deelnemers = [],
    setDeelnemers,
    loading,
...
ConFormDeelnemersStage.displayName = 'ConFormDeelnemersStage';

export default ConFormDeelnemersStage;
