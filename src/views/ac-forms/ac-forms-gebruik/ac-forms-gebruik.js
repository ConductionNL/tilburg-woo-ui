...
const AcFormsGebruik = () => {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      // Changed endpoint to /gebruik
      const response = await fetch(
        `${BASE_URL}/openconnector/api/endpoint/gebruik`,
        {
          method: 'POST',
          headers: {
  ...
  // Rest of the component logic would be the same as AcRegister...
  // For brevity, I'll just include the main render structure
  ...
  if (registerCallBack === 'success') {
    return (
      <AcSection spacing>
        <AcContainer>
          <AcColumn gap="lg">
            <Heading1>Gebruik Aanmelding Gelukt!</Heading1>
            <Alert type="ok">
              <Paragraph>
                Uw aanmelding voor gebruik is succesvol ingediend. U ontvangt
      ...
      <AcContainer>
        <AcColumn gap="lg">
          <div>
            ...
            <Paragraph>
              Vul dit formulier in om gebruik aan te melden voor onze diensten.
            </Paragraph>
          </div>
          ...
          <ProcessSteps
            steps={[
              { status: currentStep >= 0 ? 'current' : 'incomplete', title: 'Basisgegevens' },
          ...
          <div className="ac-register-form-content">
            ...
            <p>Formulier content for step {currentStep + 1} would go here...</p>
          </div>
          ...
          <div className="ac-register-form-actions">
            ...
            {currentStep < 2 ? (
              ...
              <AcButton
                ...
                disabled={!isFormValid || loading}
              >
                {loading ? 'Bezig met verzenden...' : 'Gebruik Aanmelden'}
              </AcButton>
            )}
          </div>
        </AcColumn>
