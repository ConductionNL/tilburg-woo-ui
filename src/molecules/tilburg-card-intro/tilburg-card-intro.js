...
const TilburgCardIntro = ({ title, description, image }) => {
    ...
    return (
        <TilburgCard blue>
            ...
            <Paragraph lead>
                Woo-verzoek: alle relevante documenten, informatie en correspondentie betreffende het overleg tussen de gemeente en Somerset Capital Partners B.V. / Somerset Real Estate B.V. / Intospace vanaf 1 januari 2016 tot nu.
            </Paragraph>
